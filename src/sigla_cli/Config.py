...
class Config(configparser.ConfigParser):
    ...
    def __init__(self, sigma_path=".sigla", config_filename="config.ini", *args, **kwargs):
        ...
        self["sigla"]['templates'] = self["sigla"].get('templates', '.sigla/templates')
        self["sigla"]['snapshots'] = self["sigla"].get('snapshots', '.sigla/snapshots')
        self["sigla"]['definitions'] = self["sigla"].get('definitions', '.sigla/definitions')
    ...
    def create_missing_templates(self):
        return self["templates"].getboolean('create_missing_templates', fallback=True)
